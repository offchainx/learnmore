...
const StudentCarePage: React.FC = () => {
  ...
  const t = {
    ...
    zh: {
      ...
      manifesto: {
        title: "我们的宣言",
        text: "我们坚信精英教育不应是少数人的特权，而是一项基本人权。每个学生都值得拥有一位懂他们、不知疲倦并全力支持他们成功的个性化导师——无论他们的家庭背景如何。"
      },
      program: {
        title: "教育普惠计划",
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
            ...
            <div>
               ...
               <ul className="space-y-4 text-sm text-slate-400">
                  <li><button onClick={() => navigate('/how-it-works')} className="hover:text-blue-400 transition-colors text-left">{currentT.footer.features}</button></li>
                  <li><button onClick={() => navigate('/pricing')} className="hover:text-blue-400 transition-colors text-left">{currentT.footer.pricing}</button></li>
                  <li><button onClick={() => navigate('/success-stories')} className="hover:text-blue-400 transition-colors text-left">{currentT.footer.stories}</button></li>
               </ul>
            </div>
            ...
            <div>
               ...
               <ul className="space-y-4 text-sm text-slate-400">
                  <li><button onClick={() => navigate('/blog')} className="hover:text-blue-400 transition-colors text-left">{currentT.footer.blog}</button></li>
                  <li><button onClick={() => navigate('/study-guides')} className="hover:text-blue-400 transition-colors text-left">{currentT.footer.guides}</button></li>
                  <li><button onClick={() => navigate('/student-care')} className="hover:text-blue-400 transition-colors text-left">{currentT.footer.care}</button></li>
               </ul>
            </div>
