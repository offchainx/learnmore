                             ...
                             return (
                                <div key={index} className="flex flex-col items-center group">
                                   ...
                                   <div className="relative w-8 h-8 flex items-center justify-center mb-6">
                                      ...
                                      {/* The Dot */}
                                      <div 
                                        className={`w-4 h-4 rounded-full border-2 transition-all duration-500 opacity-0 animate-[fadeIn_0.5s_forwards]
                                          ${isCompleted 
                                            ? 'bg-blue-500 border-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.6)]' 
                                            : isInProgress 
                                              ? 'bg-blue-950 border-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.8)] scale-125' 
