...
import { 
  BookOpen, Users, Video, Zap, Brain, ArrowRight, Target, 
  CheckCircle2, XCircle, ChevronRight, Play, Star, Map,
  Smartphone, BarChart2, ShieldCheck, HelpCircle, Phone, Mail, MapPin,
  TrendingUp, Activity, Layers, Sparkles, Share2, ChevronLeft, Quote
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-blue-500/30 selection:text-blue-100 overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                <Button size="xl" variant="glow" onClick={() => navigate('/register')} className="h-14 px-8 text-base shadow-blue-500/25">
                  {t.hero.ctaPrimary}
                </Button>
      ...
      <section className="py-20 text-center">
         <div className="max-w-3xl mx-auto px-4">
            ...
            <Button size="xl" variant="glow" onClick={() => navigate('/register')} className="px-12 py-6 text-lg rounded-full">
               {t.cta.btn}
            </Button>
         </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
            ...
            <div>
               ...
               <ul className="space-y-4 text-sm text-slate-400">
                  <li><button onClick={() => navigate('/how-it-works')} className="hover:text-blue-400 transition-colors text-left">{t.footer.features}</button></li>
                  <li><button onClick={() => navigate('/pricing')} className="hover:text-blue-400 transition-colors text-left">{t.footer.pricing}</button></li>
                  <li><button onClick={() => navigate('/success-stories')} className="hover:text-blue-400 transition-colors text-left">{t.footer.stories}</button></li>
               </ul>
            </div>
            ...
            <div>
               ...
               <ul className="space-y-4 text-sm text-slate-400">
                  <li><button onClick={() => navigate('/blog')} className="hover:text-blue-400 transition-colors text-left">{t.footer.blog}</button></li>
                  <li><button onClick={() => navigate('/study-guides')} className="hover:text-blue-400 transition-colors text-left">{t.footer.guides}</button></li>
                  <li><button onClick={() => navigate('/student-care')} className="hover:text-blue-400 transition-colors text-left">{t.footer.care}</button></li>
               </ul>
            </div>
