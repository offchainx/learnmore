...
2. 完成 `t-004-baseline.md`，作为后续页面任务统一基线。
...
## T-004 基线绑定
- 统一基线文档：`p0-05-dashboard-p0/t-004-baseline.md`
- 后续 `T-005 ~ T-019` 默认遵循该文档，不再在各页面任务内重复发明字段定义与状态口径。
- 如页面任务存在偏离，必须在页面任务文档中增加“偏离基线说明”。
