...
| T-006.20 | 学员社区基线对齐 | codex | done | 2026-03-12：完成 `/dashboard/community` 主列表、新建帖子页与帖子详情页的 student workspace 基线对齐，统一 header、composer、筛选 tabs、帖子卡片与右侧辅助卡的深色舱体式视觉语言，保留原有社区功能链路与反馈 FAB。 |
