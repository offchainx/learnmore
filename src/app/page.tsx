...
const localTranslations = {
  ...
  ms: {
    ...
    footer: {
      ...
      rights: "© 2025 LearnMore Edu. Hak cipta terpelihara.",
      features: "Ciri-ciri",
      pricing: "Harga",
    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-blue-500/30 selection:text-blue-100 overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                <Button size="xl" variant="glow" onClick={() => router.push('/register')} className="h-14 px-8 text-base shadow-blue-500/25">
                  {t.hero.ctaPrimary}
                </Button>
      ...
      <section className="py-20 text-center">
         <div className="max-w-3xl mx-auto px-4">
            ...
            <Button size="xl" variant="glow" onClick={() => router.push('/register')} className="px-12 py-6 text-lg rounded-full">
               {t.cta.btn}
            </Button>
         </div>
      </section>
