...
export type ContentType = 'video' | 'reading' | 'quiz';
...
export const generateChapters = (subjectId: string): Chapter[] => [
  { 
    ...
    sections: [
      { id: `${subjectId}-1-1`, title: '1.1 Introduction', duration: '10 min', difficulty: 'easy', contentType: 'video', isCompleted: true, isLocked: false, xp: 20, userConfidence: 'high' },
      { id: `${subjectId}-1-2`, title: '1.2 Advanced Theory', duration: '15 min', difficulty: 'medium', contentType: 'reading', isCompleted: true, isLocked: false, xp: 35, userConfidence: 'medium' },
      { id: `${subjectId}-1-3`, title: '1.3 Practical Applications', duration: '20 min', difficulty: 'hard', contentType: 'quiz', isCompleted: false, isLocked: false, xp: 50 },
    ]
  },
  { 
    id: `${subjectId}-c2`, 
    ...
    sections: [
      { id: `${subjectId}-2-1`, title: '2.1 Data Models', duration: '12 min', difficulty: 'easy', contentType: 'video', isCompleted: false, isLocked: true, xp: 20, userConfidence: 'low' },
      { id: `${subjectId}-2-2`, title: '2.2 Complex Systems', duration: '18 min', difficulty: 'hard', contentType: 'reading', isCompleted: false, isLocked: false, xp: 45 },
    ]
  },
  { 
    id: `${subjectId}-c3`, 
    ...
    sections: [
      { id: `${subjectId}-3-1`, title: 'Mid-Term Simulation', duration: '45 min', difficulty: 'hard', contentType: 'quiz', isCompleted: false, isLocked: true, xp: 100 },
    ]
  },
];
