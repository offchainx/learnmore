...
import { ToastProps as ToastComponentProps } from "./toast"

const TOAST_LIMIT = 1
const TOAST_REMOVE_DELAY = 1000000 // A very long delay for demonstration/dev
...
export const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    ...
    case actionTypes.DISMISS_TOAST: {
      ...
      // ! Side effects ! - This means we call the action without dispatching from the reducer.
      if (toastId) {
...
// Update Toast type to not require children initially
