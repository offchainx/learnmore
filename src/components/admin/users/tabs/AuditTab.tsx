...
import { Activity, Ban, User as UserIcon, Lock, FileText } from 'lucide-react'
import { UserDetail, AuditEventType } from '@/types/admin-user'
import { generateAuditLogs } from '../mock/userMockData'
